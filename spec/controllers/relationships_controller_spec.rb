...
RSpec.describe RelationshipsController, :type => :controller do
  ...
  it "following number increases when I follow someone" do
     Relationship.create(:user_id => @user.id, :followings_id => @another_user.id)
     expect(@user.followings.count).to be > 0  
     expect(@another_user.followers.count).to be > 0  
  end


  it "following number decreases when I unfollow someone" do
     relation = Relationship.create(:user_id => @user.id, :followings_id => @another_user.id)
     
     relation.destroy

     expect(@user.followings.count).to eql(0)  
